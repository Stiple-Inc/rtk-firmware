...
If either Client or Server is enabled, a port can be designated. By default, the port is 2948 (registered as [_GPS Daemon request/response_](https://tcp-udp-ports.com/port-2948.htm)) but any port 0 to 65535 is supported.
