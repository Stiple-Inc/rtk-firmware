...
_Pairing with the 'Express Rover-5556' over Bluetooth_
...
_Bluetooth MAC address B022 is shown in the upper left corner_

**Note:** _B022_ is the last four digits of your unit's MAC address and will be unique to the device in front of you. This is helpful in case there are multiple RTK devices within Bluetooth range.
...
To enable **Mock Locations**, _Developer Mode_ in Android must be enabled. It is best to google the [most recent procedure for this](https://www.google.com/search?q=how+to+allow+mock+location+on+android) but the following procedure should work:

1. Open Android settings ![alt text](<img/MockLocation/SparkFun RTK Mock Location - Settings.png>)

2. Open _About phone_

   ![Build Number box](<img/MockLocation/SparkFun RTK Mock Location - Build Number.png>)

3. Scroll to the bottom and click on _Build number_ five or more times. The device will prompt as more taps are required.
...
_Viewing available Bluetooth Devices_
...
_Bluetooth Connection Success_
...
_NMEA received over the Bluetooth COM port_
