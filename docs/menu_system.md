...
_System Config Menu on WiFi Config Page_
...
_Menu showing various attributes of the system_
...
_System Config over WiFi Config_
...
_Enabling and Starting a Factory Reset_
...
_Issuing and confirming a Factory Reset_
...
**Note:** Log files and any other files on the SD card are _not_ removed or modified.
